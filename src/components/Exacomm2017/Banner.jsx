            ...
            <Container>
                <Row className="align-items-center">
                    <Col xs={12} md={6} xl={7} className="column">
                        <h1>
                            {`Third International Workshop on Communication Architectures for
HPC, Big Data, Deep Learning and Clouds at Extreme Scale`}
                        </h1>
                        <p>Workshop Date: Thursday, June 22nd, 2017</p>
                        <p>Location: Frankfurt Marriott Hotel, Frankfurt, Germany</p>
